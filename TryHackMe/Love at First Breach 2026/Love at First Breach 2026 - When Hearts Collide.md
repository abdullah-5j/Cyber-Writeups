...
![MD5 hint on the page](screenshots/03_md5_hint.png)
...
![Uploading a random image](screenshots/04_random_upload_no_match.png)
...
![Target dog picture](screenshots/05_target_dog_image.png)

Let's download it first and upload it on the page.

![Uploading the same dog image](screenshots/06_duplicate_upload_detected.png)
...
![MD5 of dog.jpg](screenshots/07_md5sum_of_dog.png)
...
![fastcoll generating two files with the same MD5](screenshots/08_fastcoll_collision_generated.png)

After this, both images have the exact same MD5 hash. I uploaded one of them and got the flag.

![Match complete - flag](screenshots/09_match_complete_flag.png)
